...
router.get('/admin/requests', authMiddleware, requireAdmin, repairController.listAdminRequests);
router.post('/admin/:id/approve', authMiddleware, requireAdmin, repairController.approveRepairRequest);
